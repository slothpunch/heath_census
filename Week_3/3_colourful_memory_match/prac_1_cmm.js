// Initialise arrays let variables: cards, selectedCards, score, timeLeft, gameInterval
const colours = ['red', 'blue', 'green', 'purple', 'orange', 'pink', 'red', 'blue', 'green', 'purple', 'orange', 'pink'];

// Select DOM elements to create variables: startbtn, gameContainer, scoreElement, timerElement

// Create the generateCards() function to create the card elements dynamically
// Use an iteration for an array
// Create a variable 'card' to create a div 
